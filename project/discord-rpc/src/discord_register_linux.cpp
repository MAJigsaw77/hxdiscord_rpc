...
extern void Discord_Register(const char *applicationId, const char *command)
{
...
extern void Discord_RegisterSteamGame(const char *applicationId, const char *steamId)
{
	char command[256];
